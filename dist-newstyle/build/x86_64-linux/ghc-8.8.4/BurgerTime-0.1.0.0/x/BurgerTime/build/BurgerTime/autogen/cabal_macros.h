...
/* package BurgerTime-0.1.0.0 */
#ifndef VERSION_BurgerTime
#define VERSION_BurgerTime "0.1.0.0"
#endif /* VERSION_BurgerTime */
#ifndef MIN_VERSION_BurgerTime
#define MIN_VERSION_BurgerTime(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BurgerTime */
...
/* package h-raylib-5.1.0.1 */
#ifndef VERSION_h_raylib
#define VERSION_h_raylib "5.1.0.1"
...
#define CURRENT_COMPONENT_ID "BurgerTime-0.1.0.0-inplace-BurgerTime"
